...
\end{titlepage}
    ...
    \begin{enumerate}
        \item An easy-to-use and intuitive graphical interface for the draughts game
        \begin{enumerate}
            \item A working version of draughts - obeying all rules stated in \myhy{Draughts}{1.2.1.1}
        ...
        \begin{enumerate}
            ...
            \item Ability to adjust hyperparameters of the agents from the draughts game interface (see \myhy{RLS Objs}{RLS Objectives a-e})
