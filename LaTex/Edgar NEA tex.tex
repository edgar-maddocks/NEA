...
\end{titlepage}
    ...
    calculate the gradients for tensor $d$ and then call backward on that tensor. After the backward of function of $d$ is then completed our function would return to being inside the 
    backward function of the multiplication instance associated with tensor $y$ (seen by the red arrowhead in the diagram below).
