...
\end{titlepage}
    ...
    \subsubsubsection{Structure, Hierarchy and Flow}
    \begin{figure}[h]
        \centering
        \includegraphics[scale=0.35]{MainMenuHierachyChart.drawio.png}
        \caption{Hierarchy chart for the User Interface}
    \end{figure}

    When the user interface is first shown, it displays the main menu. As seen \myhy{Design-UI-Prototyping}{here}, the main menu will allow
