...
\end{titlepage}
    ...
    The key difference between the Alpha and base classes in this module is the use of an AlphaNetwork to
    ...
    the value used is sometimes generated by the AlphaNetwork instead of always being the
