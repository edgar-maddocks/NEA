...
\end{titlepage}
    ...
    Now moving onto the two key algorithms inside of the MCTS class, we have the tree building algorithm and
    ...
    inside of the distribution is the 'most winning' position.
    ...
    these values are originally computed inside of the modified tree building function, this variation of the
    ...
    The AlphaZero agent class has high levels of abstraction, and draws from all of the previously defined modules.
    ...
    \subsubsubsection{nea.console\_checkers.checkers\_game.py}
    \begin{minted}{python}
    ...
    \subsubsubsection{nea.console\_checkers.jit\_functions.py}
    \begin{minted}{python}
    ...
    \subsubsubsection{nea.console\_checkers.consts.py}
    \begin{minted}{python}
    SIZE = 8
    ...
    \subsubsubsection{nea.checkers\_gui.checkers\_gui.py}
    \begin{minted}{python}
    import pygame
    import numpy as np
    ...
    \subsubsubsection{nea.checkers\_gui.helpers.py}
    \begin{minted}{python}
    ...
    \subsubsubsection{nea.checkers\_gui.consts.py}
    \begin{minted}{python}
    class DISPLAY:
        SCREEN_SIZE = 720
        SQUARE_SIZE = 90
    ...
    \subsubsubsection{nea.checkers\_gui.buttons.py}
    \begin{minted}{python}
    import pygame
    from abc import ABC
    ...
    \subsubsection{nea.ml.autograd.consts.py}
    \begin{minted}{python}
    ...
    \subsubsection{nea.ml.autograd.tensor.py}
    \begin{minted}{python}
    ...
    \subsubsection{nea.ml.autograd.convolve\_funcs.py}
    \begin{minted}{python}
    import numpy as np
    from numba import jit
    import time as t
    ...
    \subsubsection{nea.ml.autograd.jit\_functions.py}
    \begin{minted}{python}
