...
\end{titlepage}
    ...
    The key algorithms for this module include the search backwards through the function graph - which uses a depth first search and various algorithms relating to convolution
