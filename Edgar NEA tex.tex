...
\begin{titlepage}
    \begin{center}
        ...
        \\
        \textbf{TO DO\\1.2.3, 1.3.2.3, 1.3.3.1(Conv1D), 1.3.3.2+3, 1.4.3+4}
...
\end{titlepage}
    ...
    The second algorithm is the process of the final agent model selecting its actions. (SEE 3rd LINK IN 2.5)
