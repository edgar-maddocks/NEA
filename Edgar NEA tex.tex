...
\end{titlepage}
    ...
    \subsubsubsection{Draughts}
    For draughts, we will need only one, an environment. The environment will be used for training the reinforcement learning agent
    and will inherit from the gymnasium library's base environment class. This will provide virtual methods of initialization, a step function,
    a reset function, and a render function - which will have to be implmented.
