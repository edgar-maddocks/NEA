...
\end{titlepage}
    ...
    The star here denotes the cross-correlation operation. 
    ...
    well as functions to compute the available moves and check for a win. UML can be seen below.

    \begin{figure}[h]
        \centering
        \includegraphics[scale = 0.3]{DraughtsUML.png}
