...
\begin{titlepage}
    \begin{center}
        ...
        \begin{tabular}{|p{8cm}|p{8cm}|} \hline
            Graph Traversal & Autodiff backprop\\ \hline
            Tree Traversal & MCTS Search\\ \hline
            Advanced Matrix Operations & Dot Procuts, Convolution, Autdiff backprop, Neural Nets\\ \hline
            Recursion & MCTS Tree BackProp, Autodiff backprop\\ \hline
            User-defined algos & RL solution\\ \hline
        \end{tabular}
...
\end{titlepage}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[scale=0.5]{NNUML(simple) (2).png}
